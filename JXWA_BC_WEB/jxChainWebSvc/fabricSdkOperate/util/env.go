...
const (
	configPath = "${FABRIC_SDK_GO_PROJECT_PATH}/fixtures/config/config_test.yaml"
	//entityMatcherLocal config file containing entity matchers for local test
	entityMatcherLocal = "${FABRIC_SDK_GO_PROJECT_PATH}/fixtures/config/overrides/local_entity_matchers.yaml"
	//ConfigPathSingleOrg single org version of 'configPath' for testing discovery
	ConfigPathSingleOrg = "${FABRIC_SDK_GO_PROJECT_PATH}/fixtures/config/config_e2e_single_org.yaml"
)

// ConfigBackend contains config backend
