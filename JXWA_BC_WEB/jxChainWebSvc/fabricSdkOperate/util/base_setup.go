...
//fire alarm cc args
var FireAlarmArgs = []byte("set")
var QueryAlarmArgs = []byte("query")
var DeleteAlarmArgs = []byte("delete")
...
func GetDeployPath() string {
	const ccPath = "fixtures/testdata/go"
