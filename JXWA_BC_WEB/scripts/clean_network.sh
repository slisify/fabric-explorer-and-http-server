...
COMPOSE_PROJECT_NAME=FIXTURE_PROJECT_NAME cd ${SCRIPT_PATH}/../fixtures/dockerenv && $DOCKER_COMPOSE_CMD -f docker-compose-chaincoded.yaml -f docker-compose.yaml -f docker-compose-nopkcs11.yaml down
