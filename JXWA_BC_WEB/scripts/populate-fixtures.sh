...
function recordChannelCacheResult {
    declare FIXTURES_TREE_CHANNEL=$(ls -R fixtures/fabric/${FABRIC_FIXTURE_VERSION}/channel)
...
function recordCryptoCacheResult {
    declare FIXTURES_TREE_CRYPTO=$(ls -R fixtures/fabric/${FABRIC_CRYPTOCONFIG_VERSION}/crypto-config)
...
function isScriptCurrent {
    ...
    declare matcher='( |^)(scripts/populate-fixtures.sh)( |$)'
...
function isCryptoFixturesCurrent {
    if [ ! -d "fixtures/fabric/${FABRIC_CRYPTOCONFIG_VERSION}/crypto-config" ]; then
    ...
    declare FIXTURES_TREE=$(ls -R fixtures/fabric/${FABRIC_CRYPTOCONFIG_VERSION}/crypto-config)
...
function isChannelFixturesCurrent {
    if [ ! -d "fixtures/fabric/${FABRIC_FIXTURE_VERSION}/channel" ]; then
    ...
    declare FIXTURES_TREE=$(ls -R fixtures/fabric/${FABRIC_FIXTURE_VERSION}/channel)
